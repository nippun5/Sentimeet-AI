...
// console.log("meetingid.................here",meetingId)
//     const callToCreate = videoClient.call('default', meetingId);

//     try {
//       await callToCreate.camera.disable(); // Disable camera before joining if needed
//       await callToCreate.join({ create: true }); // Join or create the call
//       setCall(callToCreate);
//     } catch (error) {
//       console.error('Failed to join or create call:', error);
//     } finally {
//       setJoining(false);
//     }
...
//   if (!mediaSupport) {
//     return (
//       <ErrorScreen error="Your browser doesn't support camera/microphone access. Please use Chrome, Firefox, or Safari." />
//     );
//   }
